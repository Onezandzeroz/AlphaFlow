  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch VAT register for the full year as the authoritative VAT source
        try {
          const yearStart = `${selectedYear}-01-01`;
          const yearEnd = `${selectedYear}-12-31`;
          const vatResp = await fetch(`/api/vat-register?from=${yearStart}&to=${yearEnd}`);
          if (vatResp.ok) {
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Dialog open={showSAFTDialog} onOpenChange={(open) => {
                  ...
                  <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden bg-white dark:bg-[#1a1f1e]">
                    <DialogHeader>
                    ...
                    {saftStep === 'select' && (
                      <div className="space-y-6 py-4">
                        <div className="bg-gradient-to-br from-[#0d9488]/5 to-[#0d9488]/5 dark:from-[#0d9488]/10 dark:to-[#0d9488]/10 rounded-xl p-6 border border-[#0d9488]/20">
