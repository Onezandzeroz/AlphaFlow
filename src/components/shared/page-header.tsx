...
export function PageHeader({
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#0d9488] via-[#14b8a6] to-[#5eead4] dark:from-[#0f766e] dark:via-[#0d6058] dark:to-[#0d9488] p-5 sm:p-7 lg:p-8">
