  ...
  return (
    <div className="p-4 lg:p-8 space-y-6">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <Select value={actionFilter} onValueChange={setActionFilter}>
                  <SelectTrigger className="w-full bg-gray-50 dark:bg-white/[0.04] border-0">
      ...
      <Dialog open={!!detailLog} onOpenChange={(open) => { if (!open) setDetailLog(null); }}>
        <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto bg-white dark:bg-[#1a1f1e]">
          {detailLog && (
            <>
              <DialogHeader>
